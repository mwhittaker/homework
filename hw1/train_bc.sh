...
main() {
    ...
    python run_trained.py \
        --render \
        --num_rollouts 10 \
        --stats_file bc_rollouts/Reacher-v1_10rollouts.json \
    ...
    python run_trained.py \
        --render \
        --num_rollouts 1 \
        --stats_file bc_rollouts/HalfCheetah-v1_1rollouts.json \
    ...
    python run_trained.py \
        --render \
        --num_rollouts 10 \
        --stats_file bc_rollouts/Walker2d-v1_10rollouts.json \
